...
//     let films = [
//     movie,
//     new Movies('Titanic', '1997', 'James Cameron', '$200 mln.', '$3,6 bln.'),
//     new Movies('Jurassic World', '2015', 'Colin Trevorrow', '$150 mln.', '$1,6 bln.'),
// ];

// console.log(films.getIntroduction());
// console.log(films.getProfit());
