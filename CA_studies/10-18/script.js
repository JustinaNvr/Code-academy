...
let arrMultiplied = numbers => {

  let multiplied = numbers.map(item => {
    return item * numbers.length
  })
  return multiplied;
}

console.log('arrMultiplied: ' + arrMultiplied(numbers));

// 3. Parašykite funkciją arrCountTwos, kuri suskaičiuoja dvejetus masyve
let arrCountTwos = numbers => {
  let strain = numbers.filter(v => v === 2);
...
let arrIndexOfFirst = numbers => {
  let strain = numbers.filter(v => typeof v === 'number');
  let first = strain.slice(0, 1).shift();
  return strain.indexOf(first);
}
console.log('arrIndexOfFirst: ' + arrIndexOfFirst(numbers));
...
let arrIndexOfLast = numbers => {
  let strain = numbers.filter(v => typeof v === 'number');
  // let last = strain.pop();
  let index = strain.indexOf(strain.pop());
  return index;
}
console.log('arrIndexOfLast: ' + arrIndexOfLast(numbers));
...
console.log('reverseNumbers: ' + reverseNumbers(numbers));
...
let checkForLetters = numbers => {
  
}
console.log('maxAndMin: ' + checkForLetters(numbers));
